...
import { DollarSign, TrendingUp, TrendingDown, CheckCircle2, Clock, AlertTriangle, AlertCircle, Zap, ChevronRight } from "lucide-react";
...
export function SpendIntelligencePanel(props: Partial<SpendIntelligencePanelProps>) {
  ...
  return (
    <div className="bg-card/40 border border-border/50 rounded-2xl p-6 backdrop-blur-sm space-y-5">
      {/* Header */}
      ...
      {/* Horizontal layout: Spend summary left + Needs Attention right */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Right: Needs Attention — spans 2 cols */}
