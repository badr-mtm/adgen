...
const GlobalReachMap = ({
  ...
  return <div className="relative w-full h-[400px] lg:h-[500px] rounded-3xl overflow-hidden border border-border bg-card backdrop-blur-xl group">
    ...
    <div className="absolute inset-0 z-0">
      <MapContainer center={[54, -98]} zoom={4} minZoom={2} maxZoom={6} worldCopyJump={true} style={{
        height: "100%",
        width: "100%",
          ...
          if (isActive) {
            ...
            layer.bindPopup(`
                    <div style="padding: 12px; font-family: system-ui, -apple-system, sans-serif; min-width: 180px;">
                      ...
                      <p style="font-weight: 800; font-size: 15px; margin: 0 0 4px 0; color: hsl(var(--foreground)); tracking-tight: -0.02em;">${feature.properties.name}</p>
                      <p style="font-size: 11px; color: hsl(var(--muted-foreground)); margin: 0;">United States</p>
                      <div style="margin-top: 10px; padding-top: 8px; border-top: 1px solid hsl(var(--border) / 0.5);">
